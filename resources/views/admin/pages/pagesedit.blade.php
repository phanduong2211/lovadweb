                                     ...
                                     <form enctype="multipart/form-data" method="POST" class="form-horizontal form-label-left" novalidate>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="{{$pages->name}}" id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="0" name="name" placeholder="Name of product" required="required" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <Input value="{{$pages->title}}" id="title" required="required" name="title" class="form-control col-md-7 col-xs-12"></input>
                                            </div>
                                        </div>                                        
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea value="" id="keyword" required="required" name="keyword" class="form-control col-md-7 col-xs-12">{{$pages->keyword}}</textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea value="" id="description" required="required" name="description" class="form-control col-md-7 col-xs-12">{{$pages->description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                    ...
                                                    <div class="x_content">
                                                        ...
                                                        <textarea name="details" id="details" value="" style="display:none;"></textarea>
                                                        <br />
