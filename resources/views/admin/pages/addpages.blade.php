                                ...
                                <div class="x_content">
                                    <br />
                                     <form enctype="multipart/form-data" method="POST" class="form-horizontal form-label-left" novalidate>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Title <span class="required">*</span>
                                            </label>   
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <Input id="title" required="required" name="title" class="form-control col-md-7 col-xs-12"></input>
                                            </div>
                                        </div>                                        
                                        <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                    ...
                                                    <div class="x_content">
                                                        ...
                                                        <textarea name="details" id="details" value="lskf" style="display:none;"></textarea>
                                                        <br />
